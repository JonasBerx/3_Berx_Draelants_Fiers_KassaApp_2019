...
class CashRegisterMainPane extends BorderPane {
    ...
    CashRegisterMainPane(DomainFacade domainFacade) {
        cashierProductOverviewPane = new CashierProductOverviewPane(domainFacade);
        salesPane = new CashierSalesPane(domainFacade);
        settingsPane = new CashierSettingsPane(domainFacade);
